class NbaTeamsTest < ActionDispatch::IntegrationTest
  test "get one team" do
    user = User.first.auth_code
    nba_team = NbaTeam.first

    get "/nba_teams/#{nba_team.neo_id}", { }, { dagger: auth_code }
    assert_equal 200, response.status

    get "/nba_teams/#{nba_team.neo_id}", { }, { }
    assert_equal 401, response.status

    get "/nba_teams/1221343432", { }, { }
  ...
  test "get multiple teams" do
    ...
    get "/nba_teams/#{nba_team.neo_id}", { ids: [nba_team1.neo_id, nba_team2.neo_id] }, { dagger: auth_code }
