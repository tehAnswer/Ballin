...
Welcome to Neo4j release 2.1.3, a high-performance graph database.
...
For full instructions, see http://neo4j.com/docs/2.1.3/deployment/
...
* Getting Started: http://neo4j.com/docs/2.1.3/introduction/
* The Neo4j Manual: http://neo4j.com/docs/2.1.3/
